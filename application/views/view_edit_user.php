...
<body>
    <div class="row justify-content-center">
        <div class="card col-md-8 mt-5">
            ...
            <div class="card-body">
                <div class="form-user">
                    <form action="<?php echo base_url('index.php/dashboard/update_user'); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-1">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" id="password" name="password" value="<?php echo isset($user->password) ? $user->password : '' ?>">
                            <div class="error-block"></div>
                        </div>
                    ...
                    <div>
                        <?php
                        echo '<p class="text-danger">', null !== $this->session->flashdata('update_error') ? $this->session->flashdata('update_error') : '', '<p>'; ?>
                    </div>
